...
sudo balooctl6 suspend # Усыпляем работу индексатора
sudo balooctl6 disable # Отключаем Baloo
sudo balooctl6 purge # Чистим кэш
...
kwriteconfig6 --file kwinrc --group NightColor --key LatitudeAuto 54.799
kwriteconfig6 --file kwinrc --group NightColor --key LatitudeFixed=54.8
kwriteconfig6 --file kwinrc --group NightColor --key LongitudeFixed=55.91
kwriteconfig6 --file kwinrc --group NightColor --key LongtitudeAuto 55.9053
